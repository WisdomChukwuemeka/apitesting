...
export const Layout = () => {
    ...
    return(
        <>
        <div>
            <header class='bg-gradient-to-r from-red-700 to-black h-fit'>
            ...
            <div class='md:hidden lg:hidden w-full'>
                    {menu ? (
                     ''
                           ...
                           <div class='bg-red-500 h-fit w-full' >
                        <ul class='flex flex-col items-center gap-10 p-5  text-white'>
                            <div class='hover:bg-black w-full text-center cursor-pointer'>
                                <li class='md:hidden lg:hidden'>About</li>
                            </div >
                            <div class='hover:bg-black w-full text-center cursor-pointer'>
                                <li class='md:hidden lg:hidden'>Support</li>
                            </div >
                            <div class='hover:bg-black w-full text-center cursor-pointer'>
                                <li class='md:hidden lg:hidden'>Contact</li>
                            </div>                    </ul>
                    </div>
                    )}
